        ...
        var addxxfb = function (e) {
            ...
            $("#tijiao").off('click').on('click',function () {
                ...
                jqxhr=$.ajax({
                    ...
                    type:'post',
                    dataType:'json',
                    data:{'bt':bt,'nr':nr,'fbrq':fbrq,'lb':lb,'bd':bd,'fbbm':fbbm,'lx':2,
        ...
        $(function () {
            ...
            $("#xxfb_Export").on('click',function() {
                ...
                layer.confirm('确认导出吗?',{btn:['确认','取消']
                    ...
                    window.open("../../jxxfb/getExportFindhxx?lx=2&title=" + $("#xxfb-title").val()+"&datetimeStart=" + $("#xxfb-datetimeStart").val() + "&datetimeEnd=" + $("#xxfb-datetimeEnd").val() + "&type=" + $("#xxfb-type option:selected").html())
                },function () {
